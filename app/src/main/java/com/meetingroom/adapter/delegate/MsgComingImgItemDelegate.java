 ...
 */
public class MsgComingImgItemDelegate implements ItemViewDelegate<ChatMessage> {
    private Context mContext;
    public MsgComingImgItemDelegate(){}
    public MsgComingImgItemDelegate(Context context){mContext=context;}
    @Override
    public int getItemViewLayoutId() {
        return R.layout.item_listformat_chatmsg_coming_img;
    }

    @Override
    public boolean isForViewType(ChatMessage item, int position) {
        return item.msgComing && item.isEmoji;
    }
