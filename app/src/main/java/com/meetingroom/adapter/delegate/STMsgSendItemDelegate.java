 ...
 */
public class STMsgSendItemDelegate implements ItemViewDelegate<SupportMessage> {
   private Context mContext;
    public STMsgSendItemDelegate(){}
    public STMsgSendItemDelegate(Context context){this.mContext = context;}
