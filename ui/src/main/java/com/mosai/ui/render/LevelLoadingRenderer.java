...
public class LevelLoadingRenderer extends LoadingRenderer {
    ...
    public LevelLoadingRenderer setColor(int color){
        mLevel1Color = mLevel2Color =  mLevel3Color = color;
        return this;
    }
    ...
    public LevelLoadingRenderer setCircleColor(int color) {
