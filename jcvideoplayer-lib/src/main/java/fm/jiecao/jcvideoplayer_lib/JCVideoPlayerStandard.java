...
//                    }
    ...
    public void setAllControlsVisible(int topCon, int bottomCon, int startBtn, int loadingPro,
        ...
        bottomContainer.setVisibility(isOpenLiveMode ? GONE : bottomCon);
        ...
        bottomProgressBar.setVisibility( isOpenLiveMode ? View.GONE : bottomPro );
...
//            localLayoutParams.y = getContext().getResources().getDimensionPixelOffset(R.dimen.jc_volume_dialog_margin_left);
                    ...
                    ((Activity) getContext()).runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if (currentScreen != SCREEN_WINDOW_TINY) {
                                bottomProgressBar.setVisibility( isOpenLiveMode ? View.GONE : View.VISIBLE );
                            }
                        }
                    });
                }
    ...
    private boolean isOpenLiveMode, isHideStartButton;
    public void openLiveMode(){
        this.isOpenLiveMode = true;
        this.isHideStartButton = true;
